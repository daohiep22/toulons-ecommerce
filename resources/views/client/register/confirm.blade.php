            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="login_box_img">
                        <div class="hover">
                            ...
                            <p>Hãy kiểm tra tin nhắn được gửi về hòm thư của bạn, nếu chưa thấy, hãy lặp lại quá trình đăng kí và đảm bảo rằng bạn đã nhập email hợp lệ</p>
                ...
                <div class="col-lg-6">
                    <div class="login_form_inner">
                        ...
                        ?>
                        <form class="row login_form" action="{{URL::to('/registerpost-final')}}" id="register_form" method="post">
                            @csrf
